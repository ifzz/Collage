...
struct CameraComponent {
	...
	int windowRenderWidth, windowRenderHeight;
	int sceneCount;
	int x, y;
	int panX, panY;
	int windowX, windowY;
...
void setCameraWindowSize(unsigned int, int, int);
void setCameraRenderSize(unsigned int, int, int);
void setCameraWindowPosition(unsigned int, int, int);
void setCameraZoomRate(unsigned int, double);
void setCameraZoom(unsigned int, double);
