...
OFILES = src/tests/test-Worlds.c src/tests/actors.o src/tests/abilities.o src/tests/components/health.o src/tests/components/physics.o src/world.o src/entity.o src/scene.o src/sprite.o src/timestep.o src/worldPosition.o src/component.o src/system.o src/framework/list.o src/framework/strings.o src/framework/numbers.o src/framework/display.o src/framework/sprite.o
